...
def dir_walker(aim_path: str, total_dct: dict = None) -> dict[str, dict[str]]:
    if total_dct is None:
        total_dct = {}
        basic_path = os.path.split(os.path.abspath(aim_path))     #('C:\Users\maksi\PycharmProjects\pythonDomashka_8_26.07.2023')
...
def main():
    ...
    tst_path = '\\Users\maksi\PycharmProjects\pythonDomashka_8_26.07.2023\\'
